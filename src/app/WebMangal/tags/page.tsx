  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      <div className="mangal-tags-content" style={{ maxWidth: '900px', margin: '0 auto', padding: '48px 24px' }}>
        <a href="/WebMangal" style={{ fontSize: '12px', color: 'var(--text-tertiary)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '4px' }}><ArrowLeft size={12} strokeWidth={2} /> Back to WebMangal</a>
