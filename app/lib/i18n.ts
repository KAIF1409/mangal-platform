...
const TRANSLATIONS: Record<UiLanguage, Record<string, string>> = {
  en: {
    ...
    madeWithLove: 'Made with love in India · Free to read, forever.',
  ...
  hi: {
    ...
    deleteAccountTitle: 'मेरा अकाउंट डिलीट करें',
    ...
    madeWithLove: 'भारत में प्यार से बना · पढ़ना हमेशा मुफ़्त।',
