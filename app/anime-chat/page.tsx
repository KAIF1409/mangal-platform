...
// ── Anime Chat — demo/mockup page ──
// A standalone community space for anime talk, separate from AnimeTube's
...
const DEMO_POSTS: DemoPost[] = [
  ...
  { id: '2', author: 'ReaderX', tag: 'Fan Art', text: 'Drew a quick fan piece of the Aryavarta protagonist after watching the AI trailer on AnimeTube 🔥', replies: 8, likes: 51, time: '5h', avatarGradient: 'linear-gradient(135deg, #059669, #7b2cbf)' },
...
export default function AnimeChatPage() {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-primary)', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <Link href="/animetube" style={{
            ...
            color: '#f472b6', textDecoration: 'none', border: '1px solid rgba(219,39,119,0.35)',
            whiteSpace: 'nowrap',
          }}>🎬 AnimeTube</Link>
          <ThemeToggle size={30} />
          <Link href="/" style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: '14px', color: 'var(--text-secondary)', maxWidth: '560px', margin: '0 auto' }}>
          Theories, fan art, reactions, and requests for what MANGAL creators should adapt next on AnimeTube.
