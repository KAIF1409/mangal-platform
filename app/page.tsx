      ...
      <div style={{
        ...
        <section style={{ padding: 'clamp(60px,8vw,100px) 24px', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            >
              <div style={{ flexShrink: 0, width: '90px', height: '130px', borderRadius: '12px', overflow: 'hidden', position: 'relative' }}>
                <Image src="/comics.jpg" alt="MangaNovels" fill style={{ objectFit: 'cover' }} />
              </div>
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontWeight: 900, fontSize: '14px', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ fontSize: '16px' }}>📖</span> MangaNovels
                </div>
            ...
            >
              <div style={{ textAlign: 'left', flex: 1 }}>
                <div style={{ fontWeight: 900, fontSize: '14px', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                  <Image src="/katube-logo.png" alt="KaTube" width={90} height={45} style={{ height: '17px', width: 'auto', objectFit: 'contain' }} />
              ...
              <div style={{ flexShrink: 0, width: '150px', height: '95px', borderRadius: '12px', overflow: 'hidden', position: 'relative', background: '#000' }}>
            ...
            >
              ...
              <div style={{ textAlign: 'left' }}>
                <div style={{ fontWeight: 900, fontSize: '14px', color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                  <Image src="/kcircle-logo.png" alt="K Circle" width={100} height={43} style={{ height: '17px', width: 'auto', objectFit: 'contain' }} />
                  <span style={{ fontSize: '9.5px', fontWeight: 800, padding: '2px 6px', borderRadius: '20px', background: 'rgba(217,119,6,0.18)', border: '1px solid rgba(217,119,6,0.45)', color: '#b45309' }}>COMING SOON</span>
                </div>
                <div style={{ fontSize: '12px', color: 'var(--text-secondary)', marginTop: '4px', lineHeight: 1.45 }}>
